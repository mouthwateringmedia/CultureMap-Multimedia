...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cm_multimedia_publisher', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=175)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('cm_multimedia', ['Publisher'])

        # Adding field 'EmbeddedContent.publisher'
        db.add_column('cm_multimedia_embeddedcontent', 'publisher',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cm_multimedia.Publisher'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Publisher'
        db.delete_table('cm_multimedia_publisher')

        # Deleting field 'EmbeddedContent.publisher'
        db.delete_column('cm_multimedia_embeddedcontent', 'publisher_id')
