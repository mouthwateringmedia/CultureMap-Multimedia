...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmbeddedContent.url'
        db.add_column('cm_multimedia_embeddedcontent', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmbeddedContent.file'
        db.add_column('cm_multimedia_embeddedcontent', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmbeddedContent.code'
        db.add_column('cm_multimedia_embeddedcontent', 'code',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmbeddedContent.ctype'
        db.add_column('cm_multimedia_embeddedcontent', 'ctype',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=25),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EmbeddedContent.url'
        db.delete_column('cm_multimedia_embeddedcontent', 'url')

        # Deleting field 'EmbeddedContent.file'
        db.delete_column('cm_multimedia_embeddedcontent', 'file')

        # Deleting field 'EmbeddedContent.code'
        db.delete_column('cm_multimedia_embeddedcontent', 'code')

        # Deleting field 'EmbeddedContent.ctype'
        db.delete_column('cm_multimedia_embeddedcontent', 'ctype')
