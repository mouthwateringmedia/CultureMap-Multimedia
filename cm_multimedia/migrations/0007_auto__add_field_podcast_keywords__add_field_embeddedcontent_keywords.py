...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cm_multimedia_podcast', 'keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmbeddedContent.keywords'
        db.add_column('cm_multimedia_embeddedcontent', 'keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Podcast.keywords'
        db.delete_column('cm_multimedia_podcast', 'keywords')

        # Deleting field 'EmbeddedContent.keywords'
        db.delete_column('cm_multimedia_embeddedcontent', 'keywords')
