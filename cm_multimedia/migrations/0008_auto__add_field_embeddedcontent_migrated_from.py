...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmbeddedContent.migrated_from'
        db.add_column('cm_multimedia_embeddedcontent', 'migrated_from',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EmbeddedContent.migrated_from'
        db.delete_column('cm_multimedia_embeddedcontent', 'migrated_from')
