...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmbeddedContent.duration'
        db.add_column('cm_multimedia_embeddedcontent', 'duration',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EmbeddedContent.duration'
        db.delete_column('cm_multimedia_embeddedcontent', 'duration')
