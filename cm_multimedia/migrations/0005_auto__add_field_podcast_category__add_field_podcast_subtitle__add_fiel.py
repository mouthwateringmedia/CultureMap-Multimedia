...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.category'
        db.add_column('cm_multimedia_podcast', 'category',
                      self.gf('django.db.models.fields.CharField')(default='Narf Category', max_length=255),
                      keep_default=False)

        # Adding field 'Podcast.subtitle'
        db.add_column('cm_multimedia_podcast', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Podcast.image'
        db.add_column('cm_multimedia_podcast', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Podcast.author'
        db.add_column('cm_multimedia_podcast', 'author',
                      self.gf('django.db.models.fields.CharField')(default='Pinky and The Brain', max_length=255),
                      keep_default=False)

        # Adding field 'Podcast.author_email'
        db.add_column('cm_multimedia_podcast', 'author_email',
                      self.gf('django.db.models.fields.EmailField')(default='narf@example.com', max_length=255),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Podcast.category'
        db.delete_column('cm_multimedia_podcast', 'category')

        # Deleting field 'Podcast.subtitle'
        db.delete_column('cm_multimedia_podcast', 'subtitle')

        # Deleting field 'Podcast.image'
        db.delete_column('cm_multimedia_podcast', 'image')

        # Deleting field 'Podcast.author'
        db.delete_column('cm_multimedia_podcast', 'author')

        # Deleting field 'Podcast.author_email'
        db.delete_column('cm_multimedia_podcast', 'author_email')
    ...
    models = {
        ...
        'cm_multimedia.embeddedcontent': {
            ...
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cm_multimedia.Publisher']", 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'cm_multimedia.podcast': {
